...
search_k = col1.number_input("검색할 문서의 개수", min_value=1, max_value=10, value=4, step=1)
...
chunk_size = col2.number_input("Chunk Size", min_value=100, max_value=2000, value=500, step=100)
chunk_overlap = col2.number_input("Chunk Overlap", min_value=0, max_value=200, value=50, step=10)


confirm_btn = st.button("설정완료")
